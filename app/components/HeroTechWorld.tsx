  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* DECORATIVE CUBES */}
        <div className="absolute top-[20.9%] right-[7.1%] w-[3.6cqw] h-[4.3cqh] bg-white rounded-md shadow-md" />
        <div className="absolute bottom-[12.2%] left-[58%] w-[2.9cqw] h-[3.5cqh] bg-white rounded-md shadow-md" />
